...
o_imap = imap.new("mail.gmail.com", 993, "sslv3", "Inbox", 5)
...
imap_user = "warlock.gpl@gmail.com"
imap_pass = "xxxxxxxxxxxxxxxxxxx"
        ...
        if o_imap.logged_in then
			...
			if res then
                if res.unread > 0 then
                    w_imap.text = "<span color='red'><b>" .. res.unread .. "/" .. res.total .. "</b></span>"
                else
                    w_imap.text = res.unread .. "/" .. res.total
                end
			else
                w_imap.text = "E/E"
			end
